...
| `docs/HANDOVER.md` | **START HERE in a fresh session.** Where the repo actually is, four commands that verify the build, the three probe traps that have each cost a round, the state of both halves, the four recurring failure modes with their counts, what is open ranked, and what briefing mistakes to budget for. Rewritten 2026-08-14. |
